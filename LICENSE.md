# Proprietary licence and intellectual property notice

Copyright (c) 2026 [Demetra](https://www.pappers.fr/entreprise/demetra-941049322). All rights reserved.

Project name: Clear Sky Watch
Product owner: [Demetra](https://www.pappers.fr/entreprise/demetra-941049322)
...
This demo package may be used only for internal testing, demonstration, and evaluation purposes by authorized persons.

Third-party APIs, trademarks, travel website names, browser platforms, and weather data sources remain the property of their respective owners and may be subject to their own terms of service.

This licence text is a practical draft and should be reviewed by a qualified lawyer before public release or commercial distribution.
